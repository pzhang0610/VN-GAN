...
class GeiGAN(object):
    ...
    def build_contrastive_loss(self, args):
        ...
        self.fake_dst_cyc = self.G(self.fake_dst, args.gf_dim, args.z_dim, keep_prob=args.keep_prob, weight_decay=0.00004,
                               is_training=self.is_train, reuse=True, name="generator_1")
        ...
        # Cycle Loss
        self.cyc_loss = self.model.abs_loss(self.fake_dst, self.fake_dst_cyc)
        ...
        # G1 los
        self.gen_1_loss = tf.add_n([self.g1_loss + args.alpha/2. * (self.g1_l1_loss + self.cyc_loss) + args.beta*self.p_loss_fake]+reg_loss_g1)
        # D1 loss
    ...
    def test(self, args):
        ...
        # if ckpt and ckpt.model_checkpoint_path:
        #     self.saver.restore(self.sess, ckpt.model_checkpoint_path)
        self.saver.restore(self.sess, './checkpoint/20180920_cyc/model_epoch_4.ckpt-4000')
